...
public class Arbust extends Planta {
	...
	public Arbust(int edatMaxima, String nom, float absCO2, int numPlantesPlantades) {
	...
	public Planta copia() {
		return new Arbust(this.edatMaxima,this.getNom(),this.absorcioCO2, this.getNumPlantesPlantades());
	}
